...
<T.Mesh
	...
	onclick={() => onselect('grass')}
	scale={$boxHovering ? 1.1 : 1}
>
	<T.BoxGeometry args={[0.6, 0.03, 0.6, 1]} />
	<T.MeshToonMaterial color={$boxHovering ? 'blue' : 'gray'} />
</T.Mesh>
<T.Mesh
	bind:ref={meshes[1]}
...
>
	...
	<T.MeshToonMaterial color={$torusHovering ? 'blue' : 'gray'} />
</T.Mesh>
<T.Mesh
	bind:ref={meshes[2]}
...
>
	...
	<T.MeshToonMaterial color={$torusKnotHovering ? 'blue' : 'gray'} />
</T.Mesh>